...
#if (!(defined SEN15901_DRIVER_WIND_MEASUREMENTS_ENABLE) && !(defined SEN15901_DRIVER_RAINFALL_MEASUREMENTS_ENABLE))
...
typedef enum {
    ...
    SEN15901_ERROR_HW_FUNCTION_NOT_IMPLEMENTED,
    SEN15901_ERROR_BASE_GPIO = ERROR_BASE_STEP,
